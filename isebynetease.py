...
APP_KEY = '5a851020ae4960c7'  # your app key
APP_SECRET = 'YGtpztNtP3tRvh1u8SIdpeqpf6o5Mnru' # your app secret
...
def connect(audio_file_path,audio_text):
    ...
    print(j)
    #句子完整度
    contextIntegrity="Complet:"+str( round(j["integrity"], 2))+"  "
    pronunciation="Précision de la prononciation:"+str(round(j["pronunciation"],2))+"  "
    fluency="Fluidité:"+str(round(j["fluency"],2))+"  "
    speed="Vitesse:" +str(round(j["speed"],2))+" "
